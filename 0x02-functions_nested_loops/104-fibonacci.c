...
/**
 * main - Prints the first 98 Fibonacci numbers and calculates the sum of even-valued terms
 *
 * Each new term in the Fibonacci sequence is generated by adding the previous two terms.
 * The program calculates and prints the first 98 Fibonacci numbers, starting with 1 and 2.
...
int main(void)
{
    ...
    int count = 2;    /* Number of Fibonacci numbers printed so far (starting with 1 and 2) */

    /* Print the first two Fibonacci numbers (1 and 2) */
    printf("%d, %d, ", first, second);

    /* Loop to generate the remaining Fibonacci numbers and calculate the sum of even terms */
    while (count < 98)
    {
        next = first + second;
        if (next % 2 == 0)
